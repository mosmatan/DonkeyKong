...
namespace donkeykong {
    DonkeyKongGame::DonkeyKongGame() : physicsSystem(b2_nullWorldId, BOX_SCALE) {
    ...
    void DonkeyKongGame::run() {
        createEntities();
        gameLoop();
    }

    void DonkeyKongGame::gameLoop() {
    ...
    void DonkeyKongGame::createEntities() {
    ...
    void DonkeyKongGame::createLadders() {
